...
OFERTAS_ESTRUTURADAS: OfertasEstruturadas = {
    ...
    "FATEC Sorocaba": {
        PeriodoEnum.MANHA: [
            OfertaDTO("Análise e Desenvolvimento de Sistemas (ADS)", 33, None, 3.73),
            OfertaDTO("Fabricação Mecânica", 34, None, 0.88),
            OfertaDTO("Gestão da Qualidade", 33, None, 1.24),
            OfertaDTO("Manutenção de Aeronaves", 32, None, 1.84),
            OfertaDTO("Processos Metalúrgicos", 39, None, 1.15),
            OfertaDTO("Projetos Mecânicos", 39, None, 0.74),
            OfertaDTO("Sistemas Biomédicos", 36, None, 0.81),
        ],
        PeriodoEnum.TARDE: [
            OfertaDTO("Logística", 34, None, 0.74),
        ],
        PeriodoEnum.NOITE: [
            OfertaDTO("Análise e Desenvolvimento de Sistemas (ADS)", 32, None, 7.84),
            OfertaDTO("Eletrônica Automotiva", 33, None, 2.09),
            OfertaDTO("Fabricação Mecânica", 77, None, 1.61),
            OfertaDTO("Polímeros", 36, None, 0.86),
            OfertaDTO("Projetos Mecânicos", 37, None, 2.62),
        ],
        PeriodoEnum.EAD: [
            OfertaDTO("Gestão Empresarial", 33, None, 5.21),
        ],
    },
    "FATEC Sumaré": {
        PeriodoEnum.MANHA: [
